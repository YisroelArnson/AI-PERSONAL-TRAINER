/**
 * File overview:
 * Defines the worker role configuration for memory index.
 *
...
if (require.main === module) {
  startQueueObservers([QUEUE_NAMES.memoryIndex]);
  startWorkerRole('memoryIndex');
}

module.exports = {
  startMemoryIndexWorker: () => startWorkerRole('memoryIndex')
};
